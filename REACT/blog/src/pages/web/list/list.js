                ...
                <List dataSource={this.state.data}
                    ...
                    renderItem={(item, index) => (
                        <List.Item 
                            ...
                            <Tag color={color[Math.floor(Math.random() * color.length)]} key={v}>{v}</Tag>))}>
                            </IconText>,
                            <IconText icon={FolderOutlined} text={item.category.map(v => (
                            <Tag color={color[Math.floor(Math.random() * color.length)]} key={v}>{v}</Tag>))}>
                            </IconText>,
                            <IconText icon={CalendarOutlined} text={item.createdAt}>
                            </IconText>,
                            <IconText icon={EyeOutlined} text={`${item.readedCount}次浏览`}>
                            </IconText>
                            ]}
                        >
                            <List.Item.Meta
